...
function banneratas() {
  return (
    <div className='relative w-full h-screen overflow-hidden'>
        <img src="./gamabarsekolahgde.jpg" alt="" className='absolute inset-0 w-full h-full object-cover' />
  ...
  <div className="relative h-full flex flex-col justify-center px-10 md:px-20 text-white">
    ...
    <p className="text-lg md:text-2xl mt-4 italic">Mendunia dan Berbudaya</p>
